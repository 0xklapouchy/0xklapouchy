...
I am a security researcher and smart contract developer.

* 12+ years of experience as a software developer
* 5+ years of experience as a Solidity developer
* 3+ years of experience as a EVM security researcher
...
* X – [*@eeyore0x*](https://x.com/eeyore0x)
...
| Sherlock| Midas | Focus on creating secure, transparent, and efficient structures that allow investors to access the performance of select reference strategies through tokenized formats. | 🥈 2nd | [📄](https://audits.sherlock.xyz/contests/495/report) |
| CodeHawks| Tadle | Tadle offers decentralized pre-market infrastructure facilitating the bridging of liquidity between primary and secondary financial markets. | 5th | [📄](https://codehawks.cyfrin.io/c/2024-08-tadle/results?t=report)|
| Sherlock| Kwenta | KWENTA staking rewards contract. | 🥇 1st | [📄](https://audits.sherlock.xyz/contests/493/report) |
| Sherlock| Exactly | The new Exactly staking program will enable EXA token holders to earn dividends and gain additional voting power by staking their EXA tokens. | 6th | [📄](https://audits.sherlock.xyz/contests/396/report) |
...
| Sherlock| Notional | Leveraged Vault integration with Pendle where Notional users can take leverage to buy PT tokens. | 10th | [📄](https://audits.sherlock.xyz/contests/446/report) |
| Sherlock| Mellow | Modular Liquid Restaking Primitive for Permissionless LRTs Creation & Curation. | 4th | [📄](https://audits.sherlock.xyz/contests/423/report) |
...
[https://github.com/0xklapouchy/security-portfolio](https://github.com/0xklapouchy/security-portfolio)
